...
TMP_RESTORE_DIR="/home/ssm-user/tmp/data-restore-$RESTORE_DATE"
ARCHIVE_PATH="/home/ssm-user/tmp/$RESTORE_DATE.tar.gz"
S3_BUCKET="{{S3_BUCKET}}" 
...
sudo docker compose -f /home/ssm-user/docker-compose.yml down
